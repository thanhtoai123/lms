...
import { SHIFT_CATALOGUE, plannedMinutesOf, workSegments, COIN_RULE_DEFS, trialClassCode, trialClassName, attendanceModeOf, isLeaveShift, nominalMinutesOf, type PayMode } from "@satarobo/core";
