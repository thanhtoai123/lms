...
const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  TRAINING: ["curriculum:*", "course:*", "lesson:*", "document:*", "assignment:read", "assignment:configure", "class:read", "session:read", "report_card:*", "completion:read", "completion:approve", "report:read", "teacher:read", "teacher:evaluate", "holiday:read", "trials:view"],
  AUDITOR: ["*:read", "trials:view"],
  CENTER_MANAGER: [
    "lead:*", "student:*", "enrollment:*", "class:*", "session:*", "attendance:*", "session_note:*", "media:*",
    "teacher:read", "staff:read", "timesheet:read", "timesheet:approve", "finance:read", "finance:create", "finance:approve", "report_card:*", "completion:*", "report:read", "makeup:*", "automation:*", "care:*", "inventory:*", "coin:*", "document:read", "assignment:*", "compliance:read", "compliance:create", "marketing:read", "message:*", "affiliate:read", "affiliate:create", "affiliate:update", "affiliate:approve", "recruit:read", "recruit:update", "recruit:interview", "cutover:read", "cutover:create", "migration:read",
