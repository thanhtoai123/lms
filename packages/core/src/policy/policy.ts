...
const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  TRAINING: ["curriculum:*", "course:*", "lesson:*", "document:*", "assignment:read", "assignment:configure", "class:read", "session:read", "report_card:*", "completion:read", "completion:approve", "report:read", "teacher:read", "teacher:evaluate", "holiday:read"],
  AUDITOR: ["*:read"],
  CENTER_MANAGER: [
