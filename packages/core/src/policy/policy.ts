...
const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  HO_MARKETING: ["lead:read", "marketing:*", "site:*", "report:read"],
  HO_SALE: ["lead:create", "lead:read_own", "lead:update_own"],
  TRAINING: ["curriculum:*", "course:*", "lesson:*", "document:*", "class:read", "session:read", "report_card:*", "report:read"],
  AUDITOR: ["*:read"],
  CENTER_MANAGER: [
    "lead:*", "student:*", "enrollment:*", "class:*", "session:*", "attendance:*", "session_note:*", "media:*",
    "teacher:read", "staff:read", "finance:read", "report_card:*", "report:read", "makeup:*",
  ],
  CENTER_CLASS_MANAGER: ["class:*", "session:*", "attendance:*", "session_note:*", "media:*", "student:read", "enrollment:read", "makeup:*", "teacher:read"],
  CENTER_SALES_CSM: ["lead:*", "student:read", "enrollment:create", "enrollment:read", "class:read", "session:read", "makeup:*"],
  ...
  ASSISTANT_TEACHER: ["class:read_own", "session:read_own", "attendance:write_own", "media:write_own", "student:read_own"],
