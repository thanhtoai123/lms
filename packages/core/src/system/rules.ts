...
export const WEBHOOK_SOURCES = ["sepay", "public_lead"] as const;
export type WebhookSource = (typeof WEBHOOK_SOURCES)[number];
export const WEBHOOK_SOURCE_VI: Record<WebhookSource, string> = { sepay: "SePay (biến động số dư)", public_lead: "Form đăng ký học thử" };
