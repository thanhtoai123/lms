...
| **Hoàn thành khoá theo đề xuất** | GV đề xuất → quản lý duyệt / từ chối kèm lý do, chứng nhận sinh khi được duyệt. | Làm đúng vậy; vẫn giữ hoàn thành nhiều học viên một lần cho người có quyền duyệt. | Ngang bản gốc |
