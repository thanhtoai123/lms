...
| Điểm danh QR | Easy Edu | **Chưa** | Đề xuất Giai đoạn 6 |
| Thu học phí, công nợ, trả góp | Có | Có | Phiếu thu liên tục, SePay tự khớp, hoàn tiền theo buổi |
| Hoá đơn điện tử | MISA, Halozend | **Chưa** | Chỉ có phiếu thu. Học phí thường thuộc diện không chịu thuế GTGT nhưng vẫn phải lập hoá đơn khi thu tiền — cần kết nối nhà cung cấp HĐĐT (ưu tiên Giai đoạn 6) |
...
| App phụ huynh / GV | Easy Edu | Một phần | GV: PWA; PH: liên kết riêng (bài tập, khảo sát, tin nhắn). Chưa có app đăng nhập đầy đủ |
...
| Hoá đơn điện tử | NĐ 123/2020, NĐ 70/2025 | Chưa kết nối — xem mục 2 |

## 4. Việc còn lại (đề xuất thứ tự)

1. Nhập dữ liệu thật + đối soát với hệ thống cũ; chạy song song 1–2 tuần ở cơ sở pilot.
2. Kết nối hoá đơn điện tử (lập hoá đơn từ phiếu thu).
3. Ứng dụng phụ huynh đăng nhập (PWA) dùng lại liên kết tin nhắn / bài tập / học bạ.
4. Điểm danh QR, ZNS theo mẫu (nhắc học phí, lịch học), SMS brandname dự phòng.
