...
export const ADMIN_NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Đánh giá & Khảo sát", href: "/evaluations", perm: "care:read", ready: true, desc: "Trình dựng phiếu (chấm sao, một/nhiều lựa chọn, văn bản, tải ảnh), nhóm tiêu chí, đợt mở–đóng–lưu trữ." },
      { label: "Khảo sát / NPS", href: "/khao-sat", perm: "care:read", ready: true, desc: "Bản cũ: khảo sát theo mốc, điểm NPS — đang được thay dần." },
      { label: "Thông báo PH", href: "/notifications", perm: "care:read", ready: true, desc: "Thông báo gửi PH (in-app / ZNS / email) và trạng thái gửi." },
      { label: "Trung tâm thông báo", href: "/thong-bao", ready: true, desc: "Mọi thông báo của tôi: lọc theo nhóm và mức, việc Cần thực hiện, đánh dấu đã đọc." },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Vị trí công việc", href: "/nhan-su/vi-tri", perm: "staff:read", ready: true, desc: "Bộ vai trò gắn vào vị trí, phân công có hiệu lực, điều động tác nghiệp." },
      { label: "Chấm công", href: "/cham-cong", perm: "timesheet:read", ready: true, desc: "Bảng công theo ca đã xếp, cờ cần rà, kỳ công, ghi đè có lý do." },
      { label: "Lưới phân ca", href: "/cham-cong/phan-ca", perm: "timesheet:read", ready: true, desc: "Lưới tháng, khung ca tuần, chạy thử rồi ghi thật, nhập lịch từ Sheet." },
      { label: "Kỳ công & chốt", href: "/cham-cong/ky-cong", perm: "timesheet:read", ready: true, desc: "Tổng công cả kỳ, công chuẩn, chốt kỳ / mở lại kỳ có lý do." },
      { label: "Mã ca", href: "/cham-cong/danh-muc-ca", perm: "timesheet:read", ready: true, desc: "Danh mục mã ca: loại ca, số công, đoạn giờ, nơi làm." },
      { label: "Điểm chấm công", href: "/cham-cong/diem-cham", perm: "timesheet:read", ready: true, desc: "Mã QR quầy, bán kính định vị, đời khoá." },
      { label: "Màn hình QR", href: "/cham-cong/man-hinh", perm: "timesheet:read", ready: true, desc: "Trình chiếu mã QR chấm công tại quầy." },
      { label: "Duyệt đơn từ", href: "/don-tu", perm: "timesheet:read", ready: true, desc: "10 loại đơn; duyệt là áp ngay lên lịch ca và công." },
      { label: "Của tôi", href: "/cham-cong/lich-ca", ready: true, desc: "Lịch ca, công tháng, làm đơn, chấm công bằng QR." },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Nhóm người dùng", href: "/user-groups", perm: "system:read", ready: true, desc: "Nhóm nhận thông báo nội bộ và cấp quyền theo nhóm (không sửa vai trò)." },
      { label: "Vai trò & quyền", href: "/roles", perm: "system:read", ready: true, desc: "Ma trận vai trò × quyền (đọc từ policy engine)." },
      { label: "Cây tổ chức", href: "/to-chuc", perm: "system:read", ready: true, desc: "Gốc hệ thống → hội sở → khối vùng → phòng ban → cơ sở → điểm dạy; pháp nhân và quan hệ sở hữu / nhượng quyền / liên kết." },
      ...
      { label: "Tích hợp", href: "/tich-hop", perm: "system:read", ready: true, desc: "SePay, email, Zalo ZNS, rate limit, MISA AMIS, OTP, cron, form công khai; log lỗi nhà cung cấp." },
